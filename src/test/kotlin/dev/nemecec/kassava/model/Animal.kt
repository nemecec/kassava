...
sealed class Animal(val name: String) : SupportsMixedTypeEquality {
  ...
  class Cat(name: String, val mice: Int) : Animal(name = name) {
    ...
    override fun equals(other: Any?) =
      kotlinEquals(other = other, properties = properties, superEquals = { super.equals(other) })

    // only Cats can be compared to Cats
    override fun canEqual(other: Any?) = other is Cat

    override fun toString() =
      kotlinToString(properties = properties, superToString = { super.toString() })

    override fun hashCode() =
      kotlinHashCode(properties = properties, superHashCode = { super.hashCode() })
