...
/**
 * Point base class that supports mixed type equality (subclasses must override the canEqual()
 * method if they add any fields in order to preserve the equals contract).
 */
